...
<body>
    ...
    <div class="banner">
        <div class="homepageContainer">
            ...
            <p class="bannerTagline">Track your goods throughout your entire supply chain, from purchasing to productions to end sales
            </p>
        ...
        <div class="homepageContainer">
            <div class="homepageFeatures">
                <div class="homepageFeature">
                    ...
                    <p class="featureDescription">Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
                </div>
                <div class="homepageFeature">
                ...
                <div class="homepageFeature">
                    <span class="featureIcon"><i class="fa-solid fa-earth-americas"></i></span>
                ...
                <div class="homepageNotifiedContainer">
                    <div class="emailForm">
                        ...
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.
                            Molestias, dolores debitis, nam ipsa inventore voluptate sunt cupiditate, hic vel perferendis voluptas.
                            Fugiat esse maxime, accusantium unde dolore quos tenetur id!</p>
                        <form action="">
